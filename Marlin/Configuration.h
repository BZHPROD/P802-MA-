...
// Ultimaker
    #define  DEFAULT_Kp 		21.95
    #define  DEFAULT_Ki 		1.48
    #define  DEFAULT_Kd 		81.36
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    // is used to esimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_1_X 			55//15
      #define ABL_PROBE_PT_1_Y 			65//180
      #define ABL_PROBE_PT_2_X 			15//15
      #define ABL_PROBE_PT_2_Y 			65//20
      #define ABL_PROBE_PT_3_X 			105//170
      #define ABL_PROBE_PT_3_Y 			65//20

  #endif // AUTO_BED_LEVELING_GRID


  // these are the offsets to the probe relative to the extruder tip (Hotend - Probe)
  #define X_PROBE_OFFSET_FROM_EXTRUDER 		2//-25
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 		-22//-29
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 		-0.12//-12.35
